...
<div class="mainobject">
    <table width="100%" border="2px">
        <tr>
            ...
            <?php 
                $row = $res -> fetch_assoc();
                $selectionQuery = "SELECT * FROM details WHERE num != 0";
    ...
    <center><a class="pb-3" href="admindashboard.php">GO BACK</a></center><br>
    <div class="cls">
    <form action="delete_user.php" method="POST" style="width:50%; background-color: rgb(47, 134, 255); padding: 20px;">
